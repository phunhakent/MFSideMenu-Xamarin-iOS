...
namespace MFSideMenu
{
	...
	interface MFSideMenuContainerViewController : IUIGestureRecognizerDelegate
	{
		...
		MFSideMenuContainerViewController ContainerWithCenterViewController(NSObject centerViewController, [NullAllowed] NSObject leftMenuViewController, [NullAllowed] NSObject rightMenuViewController);
		...
		void ToggleLeftSideMenuCompletion([NullAllowed] Action completion);

		// -(void)toggleRightSideMenuCompletion:(void (^)(void))completion;
		[Export("toggleRightSideMenuCompletion:")]
		void ToggleRightSideMenuCompletion([NullAllowed] Action completion);

		// -(void)setMenuState:(MFSideMenuState)menuState completion:(void (^)(void))completion;
		[Export("setMenuState:completion:")]
		void SetMenuState(MFSideMenuState menuState, [NullAllowed] Action completion);
